    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" class="<?php if($page=='home')?>" aria-current="page" href="view_user.php">Student</a>
        </li>
        <li class="nav-item">
  ...
  <div class="content">    
          <div class="card">
              <div class="card-header text-center" style="background-color: lightgreen;">
                  <h1><i class="fa fa-clock"></i>STUDENTS</h1>
                  <a  class="btn btn-success" href="admin.php">ADD STUDENT</a>
              </div>  
              <script>alert('You finished patient's appointment.');</script>
          <div class="card-body">
              <table id='student-table' class='display dataTable table table-hover' style="width: 100%;">
                  <thead>
                  <tr>
                  <th style="background-color: #4CAF50;">No.</th>
                    <th style="background-color: #4CAF50;">STUDENT ID</th>
                    ...
                    <th style="background-color: #4CAF50;">DATE OF BIRTH</th>
                        ...
                        'columns': [
                            ...
                            { 
                             ...
                             "render": function(data, type, row, meta)
                             {
                                if(type === 'display')
                                {
                                    data = '<a  class="btn btn-danger"  href="delete-patient.php?del=' + row.id + '">DELETE</a>';                
                                }
                                return data;
                             }
                            },
                            { 
                             ...
                             "render": function(data, type, row, meta)
                             {
                                if(type === 'display')
                                {
                                    data = '<a class="btn btn-success" href="edit_user.php?edit=' + row.id + '">EDIT</a>';                    
                                }
                                return data;
                             }
                            }, 
